...
STATE_MESSAGES={
    ...
    5:["Здесь ты можешь выбрать, что еще хочешь узнать.", "Сейчас твой факультет - ", "Если ты хочешь изменить свой факультет, напиши команду /set_faculty, от этого могут зависеть ответы на твои вопросы.", 
    "Если ты хочешь вернуть к этому меню, напиши команду /menu.", "Если ты хочешь еще раз увидеть вступительные сообщения, напиши команду /start."],
...
STATE_REPLIES={
    ...
    3:[["Я на месте!"]],
    5:[["Анкета", "День знаний", "Кричалки"], ["Шествие", "Праздничный концерт", "Контакты"], ["Про СГИК", "Финал"]],
