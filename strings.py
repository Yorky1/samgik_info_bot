...
FACULTY_MESSAGES={
    ...
    FACULTIES[1]:"Идем в аудиторию № 332 знакомься с однокурсниками и с руководством факультета. "\
    "Из холла иди в правую дверь, поднимайся на третий этаж. Нужная тебе дверь — справа в конце коридора.",
